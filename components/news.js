...
export default () => {
  const news = [
    ...
    { id: 'express', img: express, link: 'https://www.express.co.uk/finance/city/915842/cryptocurrency-news-dow-jones-what-could-collapse-mean-bitcoin-ripple-ethereum' },
    { id: 'coinjournal', img: coinjournal, link: 'https://coinjournal.net/mybit-partners-alpine-bring-sustainable-cryptocurrency-mining-investors/' },
    { id: 'blockchainnews', img: blockchainnews, link: 'http://www.the-blockchain.com/2018/01/30/iot-platform-mybit-partners-alpine-sustainable-mining/' }
  ].map( pressRelease => (
    <div key={pressRelease.id} className='News__press-release col-md-4 col-xs-12'>
      <a target='_blank' href={pressRelease.link}>
        <img className={`News__press-release-img News__press-release-img--is-${pressRelease.id}`} src={pressRelease.img} />
      </a>
    </div>
  ))
  return (
