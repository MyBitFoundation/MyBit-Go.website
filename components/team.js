...
import { connor, ash, ian, kyle, nick, tom, natalia, jose, blank } from './constants/index'


export default () => {
  const teamMembers = [ian, natalia, ash, kyle, connor, nick, tom, jose, blank ].map(member => (
