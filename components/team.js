...
import { connor, ash, ian, kyle, nick, tom, natalia, jose, jake, mitchell, garrett, oliver, dan, blank } from './constants/index'


export default () => {
  const teamMembers = [ian, natalia, ash, kyle, connor, nick, jose, tom, jake, mitchell, garrett, oliver, dan, blank ].map(member => (
