...
const industries = ({ translator }) => {
  const industriesList = [
    ...
    { id: 'vehicles', img: vehicles, title: 'common:mybit_industries_subtitle_3' },
    { id: 'solar', img: solar, title: 'common:mybit_industries_subtitle_4' },
    { id: 'property', img: property, title: 'common:mybit_industries_subtitle_5' },
    { id: 'partners', img: partners, title: 'common:mybit_industries_subtitle_6', additional: 'common:mybit_industries_subtitle_7' },
  ].map(industry => (
